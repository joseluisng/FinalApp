...
import com.techng.joseluisng.finalapp.adapters.ChatAdapter
import com.techng.joseluisng.finalapp.models.Message
    ...
    private fun saveMessage(message: Message){
        ...
        chatDBRef.add(newMessage)
                .addOnCompleteListener {
                    //activity!!.toast("Enviado")
                }
                .addOnFailureListener {
                    activity!!.toast("Algo fallo, intente de nuevo")
                }
