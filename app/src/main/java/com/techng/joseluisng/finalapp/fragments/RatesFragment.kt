...
import com.techng.joseluisng.finalapp.adapters.RatesAdapter
import com.techng.joseluisng.finalapp.dialogues.RateDialog
    ...
    private fun saveRate(rate: Rate){
        ...
        ratesDBRef.add(newRating)
                .addOnCompleteListener {
                    activity!!.toast("Calificación agregada correctamente.")
                }
                .addOnFailureListener {
                    activity!!.toast("Ocurrio un error, Vuelve a intentarlo.")
                }
